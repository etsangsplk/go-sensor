...
A complete example for request tracing can be found in the [examples/main.go](https://cd.splunkdev.com/libraries/go-observation/blob/master/examples/main.go). Additional examples for Chi fremworks are in chi.go.
