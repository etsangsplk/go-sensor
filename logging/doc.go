...
Conceptual documentation can be found in the repository READMEs:
     SSC-Observation Overview: https://cd.splunkdev.com/core-services/ssc-observation
     Logging Package: https://cd.splunkdev.com/core-services/ssc-observation/tree/master/logging
